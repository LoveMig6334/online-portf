      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8 mb-16">
          ...
          <div className="flex gap-6">
            <a
              href="#"
              className="w-12 h-12 rounded-full bg-surface-light flex items-center justify-center text-slate-600 hover:bg-primary hover:text-white transition-all shadow-sm"
            >
              <Github size={20} />
            </a>
            <a
        ...
        <div className="text-center border-t border-slate-100 pt-8">
          <p className="text-slate-400 text-sm">
            © 2024 Nawat S. All rights reserved. Designed with ❤️ in Thailand.
          </p>
        </div>
      </div>
    </footer>
