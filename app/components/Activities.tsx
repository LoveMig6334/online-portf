...
const Activities: React.FC = () => {
  return (
    <section
      id="activities"
      className="py-20 bg-dark text-white rounded-t-[3rem] mt-20"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-12 flex flex-col md:flex-row justify-between items-end border-b border-slate-700 pb-8">
          ...
          <p className="text-slate-400 max-w-md mt-4 md:mt-0 text-right">
            Highlights of my extracurricular involvement, leadership roles, and
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 auto-rows-[200px]">
          {activities.map((activity) => (
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-linear-to-t from-black/90 via-black/20 to-transparent p-6 flex flex-col justify-end translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
