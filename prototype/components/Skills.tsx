...
import { ResponsiveContainer, BarChart, Bar, XAxis, YAxis, Tooltip, CartesianGrid, Cell, RadarChart, PolarGrid, PolarAngleAxis, PolarRadiusAxis, Radar, Legend } from 'recharts';
    ...
    <section id="skills" className="py-20 bg-surface-light">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-dark mt-2">Skills & Abilities</h2>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white p-6 md:p-8 rounded-3xl shadow-sm border border-slate-100">
            ...
            <div className="h-[300px] w-full">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={programmingData} layout="vertical" margin={{ top: 5, right: 30, left: 40, bottom: 5 }}>
            ...
            <p className="text-center text-slate-400 text-sm mt-4">Proficiency Level (%)</p>
          </div>
          ...
          <div className="bg-white p-6 md:p-8 rounded-3xl shadow-sm border border-slate-100">
            ...
            <div className="h-[300px] w-full">
             ...
             <p className="text-center text-slate-400 text-sm mt-4">Relative Strengths</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            <div className="bg-white p-6 rounded-2xl border border-slate-100 flex items-center justify-between">
                ...
                <div className="w-12 h-12 rounded-full border-4 border-primary flex items-center justify-center text-xs font-bold text-primary">100%</div>
            </div>
             <div className="bg-white p-6 rounded-2xl border border-slate-100 flex items-center justify-between">
                <div>
                ...
                <div className="w-12 h-12 rounded-full border-4 border-secondary flex items-center justify-center text-xs font-bold text-secondary">85%</div>
            </div>
             <div className="bg-white p-6 rounded-2xl border border-slate-100 flex items-center justify-between">
                <div>
                ...
                <div className="w-12 h-12 rounded-full border-4 border-slate-300 flex items-center justify-center text-xs font-bold text-slate-400">40%</div>
            </div>
        </div>
